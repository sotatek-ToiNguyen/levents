...
export default {
  components: { StylingCard },
  data: function() {
    return {
      posts: [
        {
          id: 1,
          img: 'https://levents.asia/cdn/shop/articles/4_beb631be-fb0c-4a0f-bd46-4337ec13d2bb.png?v=1700222413&width=533',
          title: "LEVENTS® 3RD ANNIVERSARY “ONE WORLD ONE LOVE”",
          link: 'aaaa',
        },
        {
          id: 2,
