...
@component('admin::components.page.header')
    @slot('title', 'Create Post')

    <li><a href="{{ route('admin.post.index') }}">Collection</a></li>
...
@section('content')
    <form method="POST" action="{{ request()->routeIs('admin.post.create') ? route('admin.post.store') : route('admin.post.update', $post->id) }}" class="form-horizontal" id="styling-create-form" enctype="multipart/form-data" novalidate>
        {{ csrf_field() }}
                    ...
                    <div class="tab-content clearfix">
                        <div class="tab-pane fade in active" id="general">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input required name="name" class="form-control " id="name" value="{{isset($post) ? $post->name : ''}}" labelcol="2" type="text">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="meta_title" class="form-control" id="meta-title" value="{{isset($post) ? $post->meta_title : ''}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <textarea name="meta_description" class="form-control" id="meta-description" rows="10" cols="10">{{isset($post) ? $post->meta_description : ''}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
